                    ...
                    <div className="col-md-12">
                        <div>
                            <h4 className="text-white" style={{marginTop: "100px", color: "white"}}>
                                Contract Address&nbsp;:&nbsp;<span style={{fontSize: "large"}}><a href="https://polygonscan.com/address/85458745sdf" className="text-white" target="_blank"> 0xc98516a06d49ee33af86385a015198a8fc667b2b</a></span>
                            </h4>
                        </div>
                    </div>
                </div>
