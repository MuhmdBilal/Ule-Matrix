                        ...
                        <div className="modal-dialog">
                            <div className="modal-content exchange_width">
                                <div className="modal-header exchange_hd">
                                    <h1>Withdrawal BNB</h1>
                                </div>
                                <div className="modal-body">
                                    <form className="box box-default table-wrapper ng-pristine ng-valid ng-valid-maxlength" onSubmit={handleSubmit}>
